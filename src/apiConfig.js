...
export const API_POST_QUOTATION = `${BASE_URL}/quotations`; // Add the endpoint for creating a new quotation    
...
export const API_GET_QUOTATIONS = `${BASE_URL}/quotations`; // Add the endpoint for fetching the list of all quotations
export const API_GET_QUOTATION = `${BASE_URL}/quotations-filtered`; // Add the endpoint for fetching a quotation by ID
...
export const API_UPDATE_QUOTATION = `${BASE_URL}/quotations`; // Add the endpoint for updating a quotation
...
export const API_DELETE_QUOTATION = `${BASE_URL}/quotations`; // Add the endpoint for deleting a quotation
